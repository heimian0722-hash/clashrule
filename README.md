...
3.59刀一个月，不限时，不限流量，限速100M，欺诈分95-100，纯净度10以下，双住宅isp，但是需要前置代理，不能直接访问，不行就取消退款再申请，退款需在线找客服处理，很快，立即到余额账户，支持信用卡、加密货币充值；
...
如果分配的端口号很高5位数，能找客服改到4位数以下，低位端口号试着看能不能直连，有时能通；
